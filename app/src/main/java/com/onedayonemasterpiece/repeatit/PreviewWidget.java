...
public final class PreviewWidget extends AppWidgetProvider {
    public static void refresh(Context c){
        ...
        Store s=Store.get(c);Store.Pending p=s.pending();boolean allowed=s.value("widget_verified","false").equals("true")&&p!=null&&p.card.preview&&!s.value("paused","false").equals("true");
