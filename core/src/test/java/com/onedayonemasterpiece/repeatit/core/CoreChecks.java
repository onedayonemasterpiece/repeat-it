...
public final class CoreChecks {
    ...
    public static void main(String[] args){
        ...
        Engine.Plan noWindowPlan=plan(2);noWindowPlan.deadline=Instant.parse("2026-09-08T07:30:00Z");Instant blockedNow=Instant.parse("2026-09-08T00:31:00Z");Engine.Decision noWindow=Engine.next(cards(1),List.of(noWindowPlan),Map.of(),blockedNow,W,List.of());
        check(noWindow.due!=null&&noWindow.due.equals(W.next(blockedNow))&&noWindow.loads.get(0).requiredPerAllowedHour==null&&noWindow.feasibility.equals("risk_no_allowed_window_before_deadline"),"no allowed window before deadline is explicit risk and learning resumes at first allowed slot");
